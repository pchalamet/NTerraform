...
namespace NTerraform.Datas
{
    ...
    public sealed class azurerm_azuread_application : NTerraform.data
    {
        ...
        [TerraformProperty(name: "available_to_other_tenants", @out: true, nested: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "oauth2_allow_implicit_flow", @out: true, nested: true, min: 0, max: 1)]
