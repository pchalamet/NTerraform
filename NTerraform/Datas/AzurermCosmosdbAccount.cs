...
namespace NTerraform.Datas
{
    ...
    public sealed class azurerm_cosmosdb_account : NTerraform.data
    {
        ...
        public sealed class consistency_policy
        {
            ...
            [TerraformProperty(name: "max_interval_in_seconds", @out: true, min: 0, max: 1)]
            public int? @MaxIntervalInSeconds { get; }

            [TerraformProperty(name: "max_staleness_prefix", @out: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "consistency_policy", @out: false, min: 0, max: 0)]
        public consistency_policy[] @ConsistencyPolicy { get; }

        [TerraformProperty(name: "enable_automatic_failover", @out: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "ip_range_filter", @out: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "offer_type", @out: true, min: 0, max: 1)]
