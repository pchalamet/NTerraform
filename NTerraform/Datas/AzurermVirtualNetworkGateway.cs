...
namespace NTerraform.Datas
{
    ...
    public sealed class azurerm_virtual_network_gateway : NTerraform.data
    {
        ...
        public sealed class bgp_settings
        {
            ...
            [TerraformProperty(name: "asn", @out: true, nested: false, min: 0, max: 1)]
            public int? @Asn { get; }
        ...
        public sealed class vpn_client_configuration
        {
            ...
            [TerraformProperty(name: "address_space", @out: true, nested: false, min: 0, max: 1)]
            public string[] @AddressSpace { get; }

            [TerraformProperty(name: "radius_server_address", @out: true, nested: false, min: 0, max: 1)]
            public string @RadiusServerAddress { get; }

            [TerraformProperty(name: "radius_server_secret", @out: true, nested: false, min: 0, max: 1)]
            ...
            [TerraformProperty(name: "vpn_client_protocols", @out: true, nested: false, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "bgp_settings", @out: false, nested: true, min: 0, max: 0)]
        public bgp_settings[] @BgpSettings { get; }

        [TerraformProperty(name: "default_local_network_gateway_id", @out: true, nested: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "vpn_client_configuration", @out: false, nested: true, min: 0, max: 0)]
        public vpn_client_configuration[] @VpnClientConfiguration { get; }

        [TerraformProperty(name: "vpn_type", @out: true, nested: true, min: 0, max: 1)]
