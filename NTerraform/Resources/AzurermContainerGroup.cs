    ...
    public sealed class azurerm_container_group : NTerraform.resource
    {
        ...
        public sealed class container
        {
            ...
            public sealed class volume
            {
                ...
                [TerraformProperty(name: "share_name", @out: false, min: 1, max: 1)]
                public string @ShareName { get; }

                [TerraformProperty(name: "storage_account_key", @out: false, min: 1, max: 1)]
            ...
            [TerraformProperty(name: "image", @out: false, min: 1, max: 1)]
            public string @Image { get; }

            [TerraformProperty(name: "memory", @out: false, min: 1, max: 1)]
            public int @Memory { get; }

            [TerraformProperty(name: "name", @out: false, min: 1, max: 1)]
            public string @Name { get; }

            [TerraformProperty(name: "command", @out: false, min: 0, max: 1)]
            public string @Command { get; }

            [TerraformProperty(name: "environment_variables", @out: false, min: 0, max: 1)]
            public Dictionary<string,string> @EnvironmentVariables { get; }

            [TerraformProperty(name: "port", @out: false, min: 0, max: 1)]
            public int? @Port { get; }

            [TerraformProperty(name: "protocol", @out: false, min: 0, max: 1)]
            public string @Protocol { get; }

            [TerraformProperty(name: "volume", @out: false, min: 0, max: 0)]
        ...
        [TerraformProperty(name: "os_type", @out: false, min: 1, max: 1)]
        public string @OsType { get; }

        [TerraformProperty(name: "resource_group_name", @out: false, min: 1, max: 1)]
        public string @ResourceGroupName { get; }

        [TerraformProperty(name: "dns_name_label", @out: false, min: 0, max: 1)]
        public string @DnsNameLabel { get; }

        [TerraformProperty(name: "fqdn", @out: true, min: 0, max: 1)]
        public string @Fqdn { get; }

        [TerraformProperty(name: "image_registry_credential", @out: false, min: 0, max: 0)]
        public image_registry_credential[] @ImageRegistryCredential { get; }

        [TerraformProperty(name: "ip_address", @out: true, min: 0, max: 1)]
        public string @IpAddress { get; }

        [TerraformProperty(name: "ip_address_type", @out: false, min: 0, max: 1)]
        public string @IpAddressType { get; }

        [TerraformProperty(name: "restart_policy", @out: false, min: 0, max: 1)]
