...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_container_service : NTerraform.resource
    {
        ...
        [TerraformProperty(name: "diagnostics_profile", @out: false, min: 1, max: 1)]
        ...
        [TerraformProperty(name: "master_profile", @out: false, min: 1, max: 1)]
        public master_profile[] @MasterProfile { get; }

        [TerraformProperty(name: "name", @out: false, min: 1, max: 1)]
        public string @Name { get; }

        [TerraformProperty(name: "orchestration_platform", @out: false, min: 1, max: 1)]
        public string @OrchestrationPlatform { get; }

        [TerraformProperty(name: "resource_group_name", @out: false, min: 1, max: 1)]
        public string @ResourceGroupName { get; }

        [TerraformProperty(name: "service_principal", @out: false, min: 0, max: 1)]
