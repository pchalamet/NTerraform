...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_dns_zone : NTerraform.resource
    {
        ...
        [TerraformProperty(name: "registration_virtual_network_ids", @out: false, min: 0, max: 1)]
        public string[] @RegistrationVirtualNetworkIds { get; }

        [TerraformProperty(name: "resolution_virtual_network_ids", @out: false, min: 0, max: 1)]
        public string[] @ResolutionVirtualNetworkIds { get; }

        [TerraformProperty(name: "tags", @out: true, min: 0, max: 1)]
        public Dictionary<string,string> @Tags { get; }

        [TerraformProperty(name: "zone_type", @out: false, min: 0, max: 1)]
