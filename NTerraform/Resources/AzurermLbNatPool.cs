...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_lb_nat_pool : NTerraform.resource
    {
        ...
        [TerraformProperty(name: "frontend_port_end", @out: false, nested: true, min: 1, max: 1)]
        public int @FrontendPortEnd { get; }

        [TerraformProperty(name: "frontend_port_start", @out: false, nested: true, min: 1, max: 1)]
