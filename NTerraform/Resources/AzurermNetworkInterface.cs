...
{
    [TerraformStructure(category: "resource", typeName: "azurerm_network_interface")]
    public sealed class azurerm_network_interface : NTerraform.resource
    {
        ...
        public sealed class ip_configuration
        {
            ...
            [TerraformProperty(name: "private_ip_address_allocation", @out: false, nested: false, min: 1, max: 1)]
            ...
            [TerraformProperty(name: "application_security_group_ids", @out: true, nested: false, min: 0, max: 1)]
            ...
            [TerraformProperty(name: "private_ip_address", @out: false, nested: false, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "ip_configuration", @out: false, nested: true, min: 1, max: 0)]
        ...
        [TerraformProperty(name: "enable_accelerated_networking", @out: false, nested: true, min: 0, max: 1)]
        public bool? @EnableAcceleratedNetworking { get; }

        [TerraformProperty(name: "enable_ip_forwarding", @out: false, nested: true, min: 0, max: 1)]
