...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_route : NTerraform.resource
    {
        ...
        [TerraformProperty(name: "next_hop_type", @out: false, nested: true, min: 1, max: 1)]
        public string @NextHopType { get; }

        [TerraformProperty(name: "resource_group_name", @out: false, nested: true, min: 1, max: 1)]
        public string @ResourceGroupName { get; }

        [TerraformProperty(name: "route_table_name", @out: false, nested: true, min: 1, max: 1)]
        public string @RouteTableName { get; }

        [TerraformProperty(name: "next_hop_in_ip_address", @out: true, nested: true, min: 0, max: 1)]
