...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_storage_account : NTerraform.resource
    {
        ...
        public sealed class custom_domain
        {
            ...
            [TerraformProperty(name: "use_subdomain", @out: false, nested: false, min: 0, max: 1)]
        ...
        public sealed class network_rules
        {
            ...
            [TerraformProperty(name: "bypass", @out: true, nested: false, min: 0, max: 1)]
            public string[] @Bypass { get; }

            [TerraformProperty(name: "ip_rules", @out: false, nested: false, min: 0, max: 1)]
            public string[] @IpRules { get; }

            [TerraformProperty(name: "virtual_network_subnet_ids", @out: false, nested: false, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "account_replication_type", @out: false, nested: true, min: 1, max: 1)]
        public string @AccountReplicationType { get; }

        [TerraformProperty(name: "account_tier", @out: false, nested: true, min: 1, max: 1)]
        ...
        [TerraformProperty(name: "access_tier", @out: true, nested: true, min: 0, max: 1)]
        public string @AccessTier { get; }

        [TerraformProperty(name: "account_encryption_source", @out: false, nested: true, min: 0, max: 1)]
        public string @AccountEncryptionSource { get; }

        [TerraformProperty(name: "account_kind", @out: false, nested: true, min: 0, max: 1)]
        public string @AccountKind { get; }

        [TerraformProperty(name: "account_type", @out: true, nested: true, min: 0, max: 1)]
        public string @AccountType { get; }

        [TerraformProperty(name: "custom_domain", @out: false, nested: true, min: 0, max: 1)]
        public custom_domain[] @CustomDomain { get; }

        [TerraformProperty(name: "enable_blob_encryption", @out: false, nested: true, min: 0, max: 1)]
        public bool? @EnableBlobEncryption { get; }

        [TerraformProperty(name: "enable_file_encryption", @out: false, nested: true, min: 0, max: 1)]
        public bool? @EnableFileEncryption { get; }

        [TerraformProperty(name: "enable_https_traffic_only", @out: false, nested: true, min: 0, max: 1)]
        public bool? @EnableHttpsTrafficOnly { get; }

        [TerraformProperty(name: "identity", @out: false, nested: true, min: 0, max: 1)]
        public identity[] @Identity { get; }

        [TerraformProperty(name: "network_rules", @out: false, nested: true, min: 0, max: 1)]
        public network_rules[] @NetworkRules { get; }

        [TerraformProperty(name: "primary_access_key", @out: true, nested: true, min: 0, max: 1)]
        public string @PrimaryAccessKey { get; }

        [TerraformProperty(name: "primary_blob_connection_string", @out: true, nested: true, min: 0, max: 1)]
        public string @PrimaryBlobConnectionString { get; }

        [TerraformProperty(name: "primary_blob_endpoint", @out: true, nested: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "primary_file_endpoint", @out: true, nested: true, min: 0, max: 1)]
        public string @PrimaryFileEndpoint { get; }

        [TerraformProperty(name: "primary_location", @out: true, nested: true, min: 0, max: 1)]
        public string @PrimaryLocation { get; }

        [TerraformProperty(name: "primary_queue_endpoint", @out: true, nested: true, min: 0, max: 1)]
        public string @PrimaryQueueEndpoint { get; }

        [TerraformProperty(name: "primary_table_endpoint", @out: true, nested: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "secondary_blob_connection_string", @out: true, nested: true, min: 0, max: 1)]
        public string @SecondaryBlobConnectionString { get; }

        [TerraformProperty(name: "secondary_blob_endpoint", @out: true, nested: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "secondary_location", @out: true, nested: true, min: 0, max: 1)]
        public string @SecondaryLocation { get; }

        [TerraformProperty(name: "secondary_queue_endpoint", @out: true, nested: true, min: 0, max: 1)]
        public string @SecondaryQueueEndpoint { get; }

        [TerraformProperty(name: "secondary_table_endpoint", @out: true, nested: true, min: 0, max: 1)]
