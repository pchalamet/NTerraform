...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_virtual_machine_scale_set : NTerraform.resource
    {
        ...
        public sealed class storage_profile_os_disk
        {
            ...
            [TerraformProperty(name: "image", @out: false, nested: false, min: 0, max: 1)]
            ...
            [TerraformProperty(name: "vhd_containers", @out: false, nested: false, min: 0, max: 1)]
        ...
        public sealed class extension
        {
            ...
            [TerraformProperty(name: "type_handler_version", @out: false, nested: false, min: 1, max: 1)]
            public string @TypeHandlerVersion { get; }

            [TerraformProperty(name: "auto_upgrade_minor_version", @out: false, nested: false, min: 0, max: 1)]
            public bool? @AutoUpgradeMinorVersion { get; }

            [TerraformProperty(name: "protected_settings", @out: false, nested: false, min: 0, max: 1)]
            public string @ProtectedSettings { get; }

            [TerraformProperty(name: "settings", @out: false, nested: false, min: 0, max: 1)]
        ...
        public sealed class os_profile_linux_config
        {
            ...
            public sealed class ssh_keys
            {
                ...
                [TerraformProperty(name: "key_data", @out: false, nested: false, min: 0, max: 1)]
            ...
            [TerraformProperty(name: "disable_password_authentication", @out: false, nested: false, min: 0, max: 1)]
        ...
        public sealed class boot_diagnostics
        {
            ...
            [TerraformProperty(name: "enabled", @out: false, nested: false, min: 0, max: 1)]
        ...
        public sealed class network_profile
        {
            ...
            public sealed class dns_settings
            {
                ...
                [TerraformProperty(name: "dns_servers", @out: false, nested: false, min: 1, max: 1)]
            ...
            public sealed class ip_configuration
            {
                ...
                public sealed class public_ip_address_configuration
                {
                    ...
                    [TerraformProperty(name: "domain_name_label", @out: false, nested: false, min: 1, max: 1)]
                    public string @DomainNameLabel { get; }

                    [TerraformProperty(name: "idle_timeout", @out: false, nested: false, min: 1, max: 1)]
                ...
                [TerraformProperty(name: "application_gateway_backend_address_pool_ids", @out: false, nested: false, min: 0, max: 1)]
                public string[] @ApplicationGatewayBackendAddressPoolIds { get; }

                [TerraformProperty(name: "load_balancer_backend_address_pool_ids", @out: false, nested: false, min: 0, max: 1)]
                ...
                [TerraformProperty(name: "primary", @out: false, nested: false, min: 0, max: 1)]
                public bool? @Primary { get; }

                [TerraformProperty(name: "public_ip_address_configuration", @out: false, nested: false, min: 0, max: 1)]
            ...
            [TerraformProperty(name: "ip_configuration", @out: false, nested: false, min: 1, max: 0)]
            public ip_configuration[] @IpConfiguration { get; }

            [TerraformProperty(name: "name", @out: false, nested: false, min: 1, max: 1)]
            public string @Name { get; }

            [TerraformProperty(name: "primary", @out: false, nested: false, min: 1, max: 1)]
            public bool @Primary { get; }

            [TerraformProperty(name: "accelerated_networking", @out: false, nested: false, min: 0, max: 1)]
            public bool? @AcceleratedNetworking { get; }

            [TerraformProperty(name: "dns_settings", @out: false, nested: false, min: 0, max: 1)]
            public dns_settings[] @DnsSettings { get; }

            [TerraformProperty(name: "ip_forwarding", @out: false, nested: false, min: 0, max: 1)]
            public bool? @IpForwarding { get; }

            [TerraformProperty(name: "network_security_group_id", @out: false, nested: false, min: 0, max: 1)]
        ...
        public sealed class os_profile
        {
            ...
            [TerraformProperty(name: "admin_password", @out: false, nested: false, min: 1, max: 1)]
            public string @AdminPassword { get; }

            [TerraformProperty(name: "admin_username", @out: false, nested: false, min: 1, max: 1)]
            public string @AdminUsername { get; }

            [TerraformProperty(name: "computer_name_prefix", @out: false, nested: false, min: 1, max: 1)]
            public string @ComputerNamePrefix { get; }

            [TerraformProperty(name: "custom_data", @out: false, nested: false, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "network_profile", @out: false, nested: true, min: 1, max: 0)]
        public network_profile[] @NetworkProfile { get; }

        [TerraformProperty(name: "os_profile", @out: false, nested: true, min: 1, max: 1)]
        ...
        [TerraformProperty(name: "storage_profile_os_disk", @out: false, nested: true, min: 1, max: 1)]
        public storage_profile_os_disk[] @StorageProfileOsDisk { get; }

        [TerraformProperty(name: "upgrade_policy_mode", @out: false, nested: true, min: 1, max: 1)]
        ...
        [TerraformProperty(name: "extension", @out: false, nested: true, min: 0, max: 0)]
        ...
        [TerraformProperty(name: "overprovision", @out: false, nested: true, min: 0, max: 1)]
        public bool? @Overprovision { get; }

        [TerraformProperty(name: "plan", @out: false, nested: true, min: 0, max: 1)]
        public plan[] @Plan { get; }

        [TerraformProperty(name: "priority", @out: false, nested: true, min: 0, max: 1)]
        public string @Priority { get; }

        [TerraformProperty(name: "single_placement_group", @out: false, nested: true, min: 0, max: 1)]
        public bool? @SinglePlacementGroup { get; }

        [TerraformProperty(name: "storage_profile_data_disk", @out: false, nested: true, min: 0, max: 0)]
        public storage_profile_data_disk[] @StorageProfileDataDisk { get; }

        [TerraformProperty(name: "storage_profile_image_reference", @out: false, nested: true, min: 0, max: 1)]
