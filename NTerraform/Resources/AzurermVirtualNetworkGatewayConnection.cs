...
namespace NTerraform.Resources
{
    ...
    public sealed class azurerm_virtual_network_gateway_connection : NTerraform.resource
    {
        ...
        public sealed class ipsec_policy
        {
            ...
            [TerraformProperty(name: "ike_encryption", @out: false, min: 1, max: 1)]
            public string @IkeEncryption { get; }

            [TerraformProperty(name: "ike_integrity", @out: false, min: 1, max: 1)]
            public string @IkeIntegrity { get; }

            [TerraformProperty(name: "ipsec_encryption", @out: false, min: 1, max: 1)]
            public string @IpsecEncryption { get; }

            [TerraformProperty(name: "ipsec_integrity", @out: false, min: 1, max: 1)]
            public string @IpsecIntegrity { get; }

            [TerraformProperty(name: "pfs_group", @out: false, min: 1, max: 1)]
            public string @PfsGroup { get; }

            [TerraformProperty(name: "sa_datasize", @out: true, min: 0, max: 1)]
            public int? @SaDatasize { get; }

            [TerraformProperty(name: "sa_lifetime", @out: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "virtual_network_gateway_id", @out: false, min: 1, max: 1)]
        public string @VirtualNetworkGatewayId { get; }

        [TerraformProperty(name: "authorization_key", @out: false, min: 0, max: 1)]
        public string @AuthorizationKey { get; }

        [TerraformProperty(name: "enable_bgp", @out: true, min: 0, max: 1)]
        public bool? @EnableBgp { get; }

        [TerraformProperty(name: "express_route_circuit_id", @out: false, min: 0, max: 1)]
        public string @ExpressRouteCircuitId { get; }

        [TerraformProperty(name: "ipsec_policy", @out: false, min: 0, max: 1)]
        public ipsec_policy[] @IpsecPolicy { get; }

        [TerraformProperty(name: "local_network_gateway_id", @out: false, min: 0, max: 1)]
        public string @LocalNetworkGatewayId { get; }

        [TerraformProperty(name: "peer_virtual_network_gateway_id", @out: false, min: 0, max: 1)]
        public string @PeerVirtualNetworkGatewayId { get; }

        [TerraformProperty(name: "routing_weight", @out: true, min: 0, max: 1)]
        ...
        [TerraformProperty(name: "use_policy_based_traffic_selectors", @out: true, min: 0, max: 1)]
