...
{
    [TerraformStructure(category: "resource", typeName: "github_repository_webhook")]
    public sealed class github_repository_webhook : NTerraform.resource
    {
        public github_repository_webhook(string[] @events,
                                         string @name,
                                         string @repository,
                                         bool? @active = null,
