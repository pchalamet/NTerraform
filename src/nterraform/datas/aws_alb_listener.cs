...
{
    [nterraform.Core.TerraformStructure(category: "data", typeName: "aws_alb_listener")]
    public sealed class aws_alb_listener : nterraform.Core.data
    {
        ...
        public aws_alb_listener(default_action[] @defaultAction = null)
        {
