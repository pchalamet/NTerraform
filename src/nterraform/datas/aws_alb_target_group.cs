...
{
    [nterraform.Core.TerraformStructure(category: "data", typeName: "aws_alb_target_group")]
    public sealed class aws_alb_target_group : nterraform.Core.data
    {
        ...
        public aws_alb_target_group(health_check[] @healthCheck = null,
