...
{
    [nterraform.TerraformStructure(category: "data", typeName: "aws_db_snapshot")]
    public sealed class aws_db_snapshot : nterraform.data
    {
        ...
        [nterraform.TerraformProperty(name: "db_instance_identifier", @out: false, min: 0, max: 1)]
        ...
        [nterraform.TerraformProperty(name: "db_snapshot_identifier", @out: false, min: 0, max: 1)]
