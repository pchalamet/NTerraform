...
{
    [nterraform.TerraformStructure(category: "data", typeName: "aws_network_acls")]
    public sealed class aws_network_acls : nterraform.data
    {
        ...
        public aws_network_acls(filter[] @filter = null,
                                string @vpcId = null)
        {
            @Filter = @filter;
            @VpcId = @vpcId;
