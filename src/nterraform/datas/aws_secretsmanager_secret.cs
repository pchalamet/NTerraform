...
{
    [nterraform.Core.TerraformStructure(category: "data", typeName: "aws_secretsmanager_secret")]
    public sealed class aws_secretsmanager_secret : nterraform.Core.data
    {
        [nterraform.Core.TerraformStructure(category: "data", typeName: "rotation_rules")]
        public sealed class rotation_rules : nterraform.Core.structure
        {
            ...
            [nterraform.Core.TerraformProperty(name: "automatically_after_days", @out: true, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "rotation_lambda_arn", @out: true, min: 0, max: 1)]
        public string @RotationLambdaArn { get; }

        [nterraform.Core.TerraformProperty(name: "rotation_rules", @out: false, min: 0, max: 0)]
