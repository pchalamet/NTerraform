...
{
    [nterraform.TerraformStructure(category: "data", typeName: "azurerm_app_service")]
    public sealed class azurerm_app_service : nterraform.data
    {
        [nterraform.TerraformStructure(category: "data", typeName: "site_config")]
        public sealed class site_config : nterraform.structure
        {
            [nterraform.TerraformStructure(category: "data", typeName: "ip_restriction")]
        ...
        [nterraform.TerraformStructure(category: "data", typeName: "site_credential")]
        ...
        [nterraform.TerraformStructure(category: "data", typeName: "connection_string")]
        ...
        [nterraform.TerraformStructure(category: "data", typeName: "source_control")]
        ...
        [nterraform.TerraformProperty(name: "app_service_plan_id", @out: true, min: 0, max: 1)]
        ...
        [nterraform.TerraformProperty(name: "https_only", @out: true, min: 0, max: 1)]
        ...
        [nterraform.TerraformProperty(name: "site_credential", @out: false, min: 0, max: 0)]
        public site_credential[] @SiteCredential { get; }

        [nterraform.TerraformProperty(name: "source_control", @out: false, min: 0, max: 0)]
