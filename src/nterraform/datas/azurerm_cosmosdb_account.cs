...
namespace nterraform.datas
{
    ...
    public sealed class azurerm_cosmosdb_account : nterraform.Core.data
    {
        ...
        public sealed class geo_location : nterraform.Core.structure
        {
            ...
            public FSharpOption<int> @FailoverPriority { get; }
        ...
        public sealed class consistency_policy : nterraform.Core.structure
        {
            ...
            public FSharpOption<string> @ConsistencyLevel { get; }
        ...
        public azurerm_cosmosdb_account(string @name,
                                        ...
                                        FSharpOption<FSharpList<consistency_policy>> @consistencyPolicy = null,
        ...
        public FSharpOption<FSharpList<consistency_policy>> @ConsistencyPolicy { get; }
        ...
        public FSharpOption<string> @OfferType { get; }
