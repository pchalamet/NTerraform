...
{
    [nterraform.TerraformStructure(category: "data", typeName: "azurerm_network_interface")]
    public sealed class azurerm_network_interface : nterraform.data
    {
        ...
        [nterraform.TerraformProperty(name: "enable_accelerated_networking", @out: true, min: 0, max: 1)]
        public bool? @EnableAcceleratedNetworking { get; }

        [nterraform.TerraformProperty(name: "enable_ip_forwarding", @out: true, min: 0, max: 1)]
