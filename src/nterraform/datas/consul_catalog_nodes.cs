...
namespace nterraform.datas
{
    ...
    public sealed class consul_catalog_nodes : nterraform.Core.data
    {
        ...
        public sealed class nodes : nterraform.Core.structure
        {
            ...
            public nodes(FSharpMap<string,tagged_addresses> @taggedAddresses = null)
            {
        ...
        public consul_catalog_nodes(FSharpList<nodes> @nodes = null,
