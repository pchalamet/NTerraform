...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_alb_target_group_attachment")]
    public sealed class aws_alb_target_group_attachment : nterraform.Core.resource
    {
        public aws_alb_target_group_attachment(string @targetGroupArn,
                                               string @targetId,
