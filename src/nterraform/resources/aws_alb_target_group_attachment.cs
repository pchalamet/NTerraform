...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_alb_target_group_attachment")]
    public sealed class aws_alb_target_group_attachment : nterraform.resource
    {
