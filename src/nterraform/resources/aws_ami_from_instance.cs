...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_ami_from_instance")]
    public sealed class aws_ami_from_instance : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "source_instance_id", @out: false, min: 1, max: 1)]
        ...
        [nterraform.TerraformProperty(name: "snapshot_without_reboot", @out: false, min: 0, max: 1)]
