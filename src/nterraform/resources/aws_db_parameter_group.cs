...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_db_parameter_group")]
    public sealed class aws_db_parameter_group : nterraform.Core.resource
    {
