...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_default_vpc")]
    public sealed class aws_default_vpc : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "assign_generated_ipv6_cidr_block", @out: true, min: 0, max: 1)]
