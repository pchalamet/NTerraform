...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_dx_hosted_public_virtual_interface")]
    public sealed class aws_dx_hosted_public_virtual_interface : nterraform.Core.resource
    {
        public aws_dx_hosted_public_virtual_interface(string @addressFamily,
                                                      int @bgpAsn,
                                                      string @connectionId,
                                                      string @name,
