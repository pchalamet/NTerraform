...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_dx_hosted_public_virtual_interface")]
    public sealed class aws_dx_hosted_public_virtual_interface : nterraform.resource
    {
