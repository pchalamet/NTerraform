...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_instance")]
    public sealed class aws_instance : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "volume_tags", @out: true, min: 0, max: 1)]
