...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_lb_listener_certificate")]
    public sealed class aws_lb_listener_certificate : nterraform.resource
    {
