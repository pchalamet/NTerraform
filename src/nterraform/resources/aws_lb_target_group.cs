...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_lb_target_group")]
    public sealed class aws_lb_target_group : nterraform.Core.resource
    {
        ...
        public aws_lb_target_group(int @port,
                                   string @protocol,
                                   string @vpcId,
