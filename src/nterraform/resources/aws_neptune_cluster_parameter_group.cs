...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_neptune_cluster_parameter_group")]
    public sealed class aws_neptune_cluster_parameter_group : nterraform.Core.resource
    {
        ...
        public aws_neptune_cluster_parameter_group(string @family,
