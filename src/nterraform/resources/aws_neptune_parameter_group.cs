...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_neptune_parameter_group")]
    public sealed class aws_neptune_parameter_group : nterraform.resource
    {
