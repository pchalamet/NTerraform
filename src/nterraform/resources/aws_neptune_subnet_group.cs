...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_neptune_subnet_group")]
    public sealed class aws_neptune_subnet_group : nterraform.Core.resource
    {
