...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_opsworks_custom_layer")]
    public sealed class aws_opsworks_custom_layer : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "short_name", @out: false, min: 1, max: 1)]
