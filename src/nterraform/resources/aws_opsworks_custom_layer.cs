...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_custom_layer")]
    public sealed class aws_opsworks_custom_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_custom_layer(string @name,
                                         string @shortName,
                                         string @stackId,
        ...
        [nterraform.Core.TerraformProperty(name: "short_name", @out: false, min: 1, max: 1)]
