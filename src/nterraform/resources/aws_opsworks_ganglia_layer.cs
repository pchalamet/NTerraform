...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_ganglia_layer")]
    public sealed class aws_opsworks_ganglia_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_ganglia_layer(string @password,
                                          string @stackId,
