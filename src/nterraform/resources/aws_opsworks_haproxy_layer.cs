...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_opsworks_haproxy_layer")]
    public sealed class aws_opsworks_haproxy_layer : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "stats_password", @out: false, min: 1, max: 1)]
        ...
        [nterraform.TerraformProperty(name: "healthcheck_method", @out: false, min: 0, max: 1)]
        public string @HealthcheckMethod { get; }

        [nterraform.TerraformProperty(name: "healthcheck_url", @out: false, min: 0, max: 1)]
        ...
        [nterraform.TerraformProperty(name: "stats_enabled", @out: false, min: 0, max: 1)]
        public bool? @StatsEnabled { get; }

        [nterraform.TerraformProperty(name: "stats_url", @out: false, min: 0, max: 1)]
        public string @StatsUrl { get; }

        [nterraform.TerraformProperty(name: "stats_user", @out: false, min: 0, max: 1)]
