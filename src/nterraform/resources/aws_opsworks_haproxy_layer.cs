...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_haproxy_layer")]
    public sealed class aws_opsworks_haproxy_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_haproxy_layer(string @stackId,
        ...
        [nterraform.Core.TerraformProperty(name: "stats_password", @out: false, min: 1, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "healthcheck_method", @out: false, min: 0, max: 1)]
        public string @HealthcheckMethod { get; }

        [nterraform.Core.TerraformProperty(name: "healthcheck_url", @out: false, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "stats_enabled", @out: false, min: 0, max: 1)]
        public bool? @StatsEnabled { get; }

        [nterraform.Core.TerraformProperty(name: "stats_url", @out: false, min: 0, max: 1)]
        public string @StatsUrl { get; }

        [nterraform.Core.TerraformProperty(name: "stats_user", @out: false, min: 0, max: 1)]
