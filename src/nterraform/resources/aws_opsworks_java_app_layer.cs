...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_java_app_layer")]
    public sealed class aws_opsworks_java_app_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_java_app_layer(string @stackId,
        ...
        [nterraform.Core.TerraformProperty(name: "app_server_version", @out: false, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "jvm_options", @out: false, min: 0, max: 1)]
        public string @JvmOptions { get; }

        [nterraform.Core.TerraformProperty(name: "jvm_type", @out: false, min: 0, max: 1)]
        public string @JvmType { get; }

        [nterraform.Core.TerraformProperty(name: "jvm_version", @out: false, min: 0, max: 1)]
