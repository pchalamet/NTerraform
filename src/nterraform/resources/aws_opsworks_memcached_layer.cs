...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_opsworks_memcached_layer")]
    public sealed class aws_opsworks_memcached_layer : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "allocated_memory", @out: false, min: 0, max: 1)]
