...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_mysql_layer")]
    public sealed class aws_opsworks_mysql_layer : nterraform.Core.resource
    {
        ...
        [nterraform.Core.TerraformProperty(name: "root_password", @out: false, min: 0, max: 1)]
        public string @RootPassword { get; }

        [nterraform.Core.TerraformProperty(name: "root_password_on_all_instances", @out: false, min: 0, max: 1)]
