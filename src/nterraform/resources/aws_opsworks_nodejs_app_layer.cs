...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_nodejs_app_layer")]
    public sealed class aws_opsworks_nodejs_app_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_nodejs_app_layer(string @stackId,
        ...
        [nterraform.Core.TerraformProperty(name: "nodejs_version", @out: false, min: 0, max: 1)]
