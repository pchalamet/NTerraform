...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_php_app_layer")]
    public sealed class aws_opsworks_php_app_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_php_app_layer(string @stackId,
