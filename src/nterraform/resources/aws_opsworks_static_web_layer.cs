...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_opsworks_static_web_layer")]
    public sealed class aws_opsworks_static_web_layer : nterraform.Core.resource
    {
        ...
        public aws_opsworks_static_web_layer(string @stackId,
