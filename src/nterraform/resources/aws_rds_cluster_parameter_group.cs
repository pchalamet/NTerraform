...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_rds_cluster_parameter_group")]
    public sealed class aws_rds_cluster_parameter_group : nterraform.Core.resource
    {
        ...
        public aws_rds_cluster_parameter_group(string @family,
