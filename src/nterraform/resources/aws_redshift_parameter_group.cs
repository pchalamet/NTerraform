...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_redshift_parameter_group")]
    public sealed class aws_redshift_parameter_group : nterraform.Core.resource
    {
