...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_route_table")]
    public sealed class aws_route_table : nterraform.Core.resource
    {
        ...
        public aws_route_table(string @vpcId,
                               route[] @route = null,
        ...
        [nterraform.Core.TerraformProperty(name: "propagating_vgws", @out: true, min: 0, max: 1)]
