...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_route_table")]
    public sealed class aws_route_table : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "propagating_vgws", @out: true, min: 0, max: 1)]
