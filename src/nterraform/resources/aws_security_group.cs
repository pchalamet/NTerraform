...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_security_group")]
    public sealed class aws_security_group : nterraform.Core.resource
    {
        ...
        public aws_security_group(string @description = null,
                                  egress[] @egress = null,
