...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_spot_instance_request")]
    public sealed class aws_spot_instance_request : nterraform.Core.resource
    {
        ...
        [nterraform.Core.TerraformProperty(name: "launch_group", @out: false, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "spot_bid_status", @out: true, min: 0, max: 1)]
        public string @SpotBidStatus { get; }

        [nterraform.Core.TerraformProperty(name: "spot_instance_id", @out: true, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "spot_type", @out: false, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "valid_from", @out: true, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "volume_tags", @out: false, min: 0, max: 1)]
