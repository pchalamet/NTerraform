...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_storagegateway_cache")]
    public sealed class aws_storagegateway_cache : nterraform.Core.resource
    {
