...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_storagegateway_upload_buffer")]
    public sealed class aws_storagegateway_upload_buffer : nterraform.resource
    {
