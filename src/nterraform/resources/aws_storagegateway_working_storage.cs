...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_storagegateway_working_storage")]
    public sealed class aws_storagegateway_working_storage : nterraform.Core.resource
    {
