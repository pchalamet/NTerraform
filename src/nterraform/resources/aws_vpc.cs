...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_vpc")]
    public sealed class aws_vpc : nterraform.Core.resource
    {
        ...
        [nterraform.Core.TerraformProperty(name: "assign_generated_ipv6_cidr_block", @out: false, min: 0, max: 1)]
        ...
        [nterraform.Core.TerraformProperty(name: "instance_tenancy", @out: false, min: 0, max: 1)]
