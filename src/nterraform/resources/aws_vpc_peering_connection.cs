...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_vpc_peering_connection")]
    public sealed class aws_vpc_peering_connection : nterraform.Core.resource
    {
        ...
        [nterraform.Core.TerraformProperty(name: "peer_vpc_id", @out: false, min: 1, max: 1)]
