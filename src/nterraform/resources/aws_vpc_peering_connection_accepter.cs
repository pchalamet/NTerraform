...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_vpc_peering_connection_accepter")]
    public sealed class aws_vpc_peering_connection_accepter : nterraform.resource
    {
