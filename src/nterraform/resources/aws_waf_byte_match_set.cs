...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_waf_byte_match_set")]
    public sealed class aws_waf_byte_match_set : nterraform.Core.resource
    {
