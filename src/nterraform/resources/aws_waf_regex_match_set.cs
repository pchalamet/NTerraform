...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_waf_regex_match_set")]
    public sealed class aws_waf_regex_match_set : nterraform.Core.resource
    {
        ...
        public aws_waf_regex_match_set(string @name,
