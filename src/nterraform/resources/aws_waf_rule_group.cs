...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_waf_rule_group")]
    public sealed class aws_waf_rule_group : nterraform.Core.resource
    {
        ...
        public aws_waf_rule_group(string @metricName,
                                  string @name,
