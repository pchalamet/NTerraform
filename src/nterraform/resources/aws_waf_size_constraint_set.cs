...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_waf_size_constraint_set")]
    public sealed class aws_waf_size_constraint_set : nterraform.Core.resource
    {
