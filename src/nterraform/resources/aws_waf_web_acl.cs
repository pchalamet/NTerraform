...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_waf_web_acl")]
    public sealed class aws_waf_web_acl : nterraform.resource
    {
        ...
        [nterraform.TerraformProperty(name: "rules", @out: false, min: 0, max: 0)]
