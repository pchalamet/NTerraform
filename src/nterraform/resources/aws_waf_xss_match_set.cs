...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_waf_xss_match_set")]
    public sealed class aws_waf_xss_match_set : nterraform.resource
    {
        [nterraform.TerraformStructure(category: "resource", typeName: "xss_match_tuples")]
        public sealed class xss_match_tuples : nterraform.structure
        {
        ...
        [nterraform.TerraformProperty(name: "xss_match_tuples", @out: false, min: 0, max: 0)]
