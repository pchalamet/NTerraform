...
{
    [nterraform.TerraformStructure(category: "resource", typeName: "aws_wafregional_byte_match_set")]
    public sealed class aws_wafregional_byte_match_set : nterraform.resource
    {
        [nterraform.TerraformStructure(category: "resource", typeName: "byte_match_tuple")]
        public sealed class byte_match_tuple : nterraform.structure
        {
        ...
        [nterraform.TerraformProperty(name: "byte_match_tuple", @out: false, min: 0, max: 0)]
