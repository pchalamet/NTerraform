...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "aws_wafregional_sql_injection_match_set")]
    public sealed class aws_wafregional_sql_injection_match_set : nterraform.Core.resource
    {
        [nterraform.Core.TerraformStructure(category: "resource", typeName: "sql_injection_match_tuple")]
        public sealed class sql_injection_match_tuple : nterraform.Core.structure
        {
        ...
        [nterraform.Core.TerraformProperty(name: "sql_injection_match_tuple", @out: false, min: 0, max: 0)]
