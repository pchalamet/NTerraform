...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "azurerm_data_lake_analytics_firewall_rule")]
    public sealed class azurerm_data_lake_analytics_firewall_rule : nterraform.Core.resource
    {
