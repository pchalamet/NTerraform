...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "azurerm_dns_ptr_record")]
    public sealed class azurerm_dns_ptr_record : nterraform.Core.resource
    {
