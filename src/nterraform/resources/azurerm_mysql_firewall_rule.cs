...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "azurerm_mysql_firewall_rule")]
    public sealed class azurerm_mysql_firewall_rule : nterraform.Core.resource
    {
