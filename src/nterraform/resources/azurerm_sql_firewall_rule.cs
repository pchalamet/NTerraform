...
{
    [nterraform.Core.TerraformStructure(category: "resource", typeName: "azurerm_sql_firewall_rule")]
    public sealed class azurerm_sql_firewall_rule : nterraform.Core.resource
    {
        public azurerm_sql_firewall_rule(string @endIpAddress,
                                         string @name,
