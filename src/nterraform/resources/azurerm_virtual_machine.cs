...
namespace nterraform.resources
{
    ...
    public sealed class azurerm_virtual_machine : nterraform.Core.resource
    {
        ...
        public azurerm_virtual_machine(string @location,
                                       ...
                                       FSharpList<os_profile> @osProfile = null,
                                       ...
                                       FSharpList<storage_data_disk> @storageDataDisk = null,
                                       FSharpList<storage_image_reference> @storageImageReference = null,
        ...
        public FSharpList<storage_data_disk> @StorageDataDisk { get; }

        [nterraform.Core.TerraformProperty(name: "storage_image_reference", @out: false, min: 0, max: 1)]
        public FSharpList<storage_image_reference> @StorageImageReference { get; }
