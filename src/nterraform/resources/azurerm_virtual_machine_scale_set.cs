    ...
    public sealed class azurerm_virtual_machine_scale_set : nterraform.Core.resource
    {
        ...
        public sealed class os_profile_secrets : nterraform.Core.structure
        {
            ...
            public os_profile_secrets(string @sourceVaultId,
                                      FSharpList<vault_certificates> @vaultCertificates = null)
            {
            ...
            public FSharpList<vault_certificates> @VaultCertificates { get; }
        }
        ...
        public sealed class os_profile_linux_config : nterraform.Core.structure
        {
            ...
            public os_profile_linux_config(bool? @disablePasswordAuthentication = null,
                                           FSharpList<ssh_keys> @sshKeys = null)
            {
            ...
            public FSharpList<ssh_keys> @SshKeys { get; }
        }
        ...
        public sealed class identity : nterraform.Core.structure
        {
            public identity(string @type,
                            FSharpList<string> @identityIds = null)
            {
                @Type = @type;
            ...
            public FSharpList<string> @IdentityIds { get; }
        ...
        public sealed class network_profile : nterraform.Core.structure
        {
            ...
            public sealed class ip_configuration : nterraform.Core.structure
            {
                ...
                public ip_configuration(string @name,
                                        string @subnetId,
                                        FSharpList<string> @applicationGatewayBackendAddressPoolIds = null,
                                        FSharpList<string> @loadBalancerBackendAddressPoolIds = null,
                                        bool? @primary = null,
                                        FSharpList<public_ip_address_configuration> @publicIpAddressConfiguration = null)
                {
                    @Name = @name;
                    @SubnetId = @subnetId;
                ...
                public FSharpList<string> @ApplicationGatewayBackendAddressPoolIds { get; }

                [nterraform.Core.TerraformProperty(name: "load_balancer_backend_address_pool_ids", @out: false, min: 0, max: 1)]
                public FSharpList<string> @LoadBalancerBackendAddressPoolIds { get; }
                ...
                public FSharpList<public_ip_address_configuration> @PublicIpAddressConfiguration { get; }
            }
            ...
            public network_profile(FSharpList<ip_configuration> @ipConfiguration,
                                   ...
                                   FSharpList<dns_settings> @dnsSettings = null,
            ...
            public FSharpList<dns_settings> @DnsSettings { get; }
        ...
        public sealed class storage_profile_os_disk : nterraform.Core.structure
        {
            public storage_profile_os_disk(string @createOption,
                                           ...
                                           string @name = null,
                                           string @osType = null,
                                           FSharpList<string> @vhdContainers = null)
            {
            ...
            public FSharpList<string> @VhdContainers { get; }
        }
        ...
        public sealed class os_profile_windows_config : nterraform.Core.structure
        {
            ...
            public os_profile_windows_config(FSharpList<additional_unattend_config> @additionalUnattendConfig = null,
                                             bool? @enableAutomaticUpgrades = null,
                                             bool? @provisionVmAgent = null,
                                             FSharpList<winrm> @winrm = null)
            {
            ...
            public FSharpList<additional_unattend_config> @AdditionalUnattendConfig { get; }
            ...
            public FSharpList<winrm> @Winrm { get; }
        }
        ...
        public azurerm_virtual_machine_scale_set(string @location,
                                                 ...
                                                 FSharpList<boot_diagnostics> @bootDiagnostics = null,
                                                 FSharpList<extension> @extension = null,
                                                 FSharpList<identity> @identity = null,
                                                 FSharpList<os_profile_linux_config> @osProfileLinuxConfig = null,
                                                 FSharpList<os_profile_secrets> @osProfileSecrets = null,
                                                 FSharpList<os_profile_windows_config> @osProfileWindowsConfig = null,
                                                 bool? @overprovision = null,
                                                 FSharpList<plan> @plan = null,
                                                 string @priority = null,
                                                 bool? @singlePlacementGroup = null,
                                                 FSharpList<storage_profile_data_disk> @storageProfileDataDisk = null,
                                                 FSharpList<storage_profile_image_reference> @storageProfileImageReference = null,
        ...
        public FSharpList<boot_diagnostics> @BootDiagnostics { get; }

        [nterraform.Core.TerraformProperty(name: "extension", @out: false, min: 0, max: 0)]
        public FSharpList<extension> @Extension { get; }
        ...
        public FSharpList<os_profile_linux_config> @OsProfileLinuxConfig { get; }

        [nterraform.Core.TerraformProperty(name: "os_profile_secrets", @out: false, min: 0, max: 0)]
        public FSharpList<os_profile_secrets> @OsProfileSecrets { get; }

        [nterraform.Core.TerraformProperty(name: "os_profile_windows_config", @out: false, min: 0, max: 1)]
        public FSharpList<os_profile_windows_config> @OsProfileWindowsConfig { get; }
        ...
        public FSharpList<storage_profile_data_disk> @StorageProfileDataDisk { get; }

        [nterraform.Core.TerraformProperty(name: "storage_profile_image_reference", @out: false, min: 0, max: 1)]
        public FSharpList<storage_profile_image_reference> @StorageProfileImageReference { get; }
